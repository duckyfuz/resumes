...
\section{AWARDS}
  \resumeSubHeadingListStart
    \resumeProjectHeading{\textbf{[Award Name]} - \emph{[Placement/Rank]} $|$ \textbf{[Organization/Competition]}}{[Year]}
    \resumeProjectHeading{\textbf{[Scholarship Name]} $|$ \textbf{[Granting Body]}}{[Year]}
  \resumeSubHeadingListEnd
% END OF SECTION %
