...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Interning under the Armoury team (https://reports.open.gov.sg/armoury/overview)}
    \resumeItemListEnd
    ...
    \resumeItemListStart
      ...
      \resumeItem{Designed RPC endpoints for action-centric workflows, reducing integration complexity}
    \resumeItemListEnd

    \resumeSubheading{\textbf{Founding Software Engineer @ \textit{Check (Iterative W25)}}}{Feb. 2025 - May 2025}
    \resumeDescription{Check offers an AI tutoring platform that enhances student performance with personalized, curriculum-aligned learning}
    \resumeItemListStart
...
\section{Projects / Extracurriculars}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{Linux Homelab} $|$ Repurposed Laptop Running Ubuntu Server}{Feb. 2024 - Present}
    \resumeItemListStart
      ...
      \resumeItem{Utilised as a cloud compute platform for self-hosting services, enabling cost-effective testing and rapid iteration}
      \resumeItem{Automated off-site backups to Backblaze B2 using cron and rsync, with Telegram notifications for status updates}
    \resumeItemListEnd
