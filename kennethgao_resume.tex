...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeDescription{B.Eng Computer Engineering (E-Scholars Programme), IEEE-Eta Kappa Nu (HKN) $|$ 4.96 GPA}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    % \resumeSubheading{\textbf{Incoming TechOps Intern @ \textit{Jump Trading}}}{May. 2026 - Aug. 2026}
    % \resumeDescription{Jump Trading is a proprietary trading firm specializing in algorithmic and high-frequency trading across the globe}
    % \resumeItemListStart
    %   \resumeItem{Incoming intern under the Central Infrastructure team}
    % \resumeItemListEnd
    ...
    \resumeItemListStart
      ...
      \resumeItem{Utilized LocalStack to mock infrastructure, streamlining local development and eliminating unreliable test mocks}
    \resumeItemListEnd
...
\section{Projects / Extracurriculars}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{LowFat Memory Safety for C/C++} $|$ LLVM instrumentation pass \& runtime}{Jan. 2026 - Present}
    \resumeItemListStart
      \resumeItem{Recreating LowFat Pointers bounds checking for LLVM 21 based on \href{https://www.comp.nus.edu.sg/~gregory/papers/cc16lowfatptrs.pdf}{\underline{Duck \& Yap (CC'16)}}}
    \resumeItemListEnd
