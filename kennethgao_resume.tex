...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://kenf.dev/}{\Large Kenneth Gao}} $|$ {\href{mailto:hello@kenf.dev}{hello@kenf.dev}} $|$ {\href{www.kenf.dev}{www.kenf.dev}} & \textbf{Availability: }Jan. 2026 onwards \\
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{National University of Singapore}}{}
    \resumeDescription{B.Eng Computer Engineering (E-Scholars Programme) - 4.9 GPA}

    % \resumeSubheading{\textbf{Hwa Chong Institution}}{Singapore}
    % \resumeSubheading{GCE A-Levels, 90/90RP (PCME) with H3 Physics Distinction}{2015 -- 2021}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{\textbf{Software Engineering Intern @ Binance}}{May 2025 - Present}
    \resumeDescription{Binance empowers users to trade, invest, and manage a cryptocurrencies seamlessly and securely on a global scale}
    \resumeItemListStart
      \resumeItem{Interning under the Security team, working on enhancing and optimizing backend services}
    \resumeItemListEnd

    \resumeSubheading{\textbf{Founding Software Engineer @ \textit{Check (Iterative W25)}}}{Feb. 2025 - Present}
    \resumeDescription{Check revolutionizes student learning through AI-driven active recall, syllabus accurate content, and smart analytics}
    \resumeItemListStart
      ...
      \resumeItem{Spearheaded migration of Next.js webapp to AWS, reducing costs by 30\% and improving performance by 20\%}
    \resumeItemListEnd
    ...
    \resumeSubheading{\textbf{Software Engineering Intern @ \textit{NodeFlair - Tech Career Platform for SEA}}}{Jan. 2024 -- Jun. 2024}
...
\section{Projects / Extracurriculars}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{Insecure File Service} $|$ Simple file sharing service for public use - \href{http://ifs.kenf.dev/}{ifs.kenf.dev}}{Sep. 2024 - Present}
    \resumeItemListStart
