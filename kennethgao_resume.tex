...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://kenf.dev/}{\Large Kenneth Gao}} $|$ {\href{mailto:hello@kenf.dev}{hello@kenf.dev}} $|$ {\href{www.kenf.dev}{www.kenf.dev}} & \textbf{Availability: }2026 onwards \\
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading{\textbf{Software Engineering Intern @ Binance}}{May 2025 - Dec. 2025}
    ...
    \resumeItemListStart
      \resumeItem{Incoming intern under the Security team, working on enhancing and optimizing backend services}
    \resumeItemListEnd

    \resumeSubheading{\textbf{Founding Software Engineer @ \textit{Check (Iterative W25)}}}{Feb. 2025 - Present}
    \resumeDescription{Check revolutionizes student learning through AI-driven active recall, syllabus accurate, and smart analytics}
    \resumeItemListStart
