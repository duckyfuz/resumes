...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\large{Kenneth Gao}} $|$ {\href{mailto:hello@kenf.dev}{hello@kenf.dev}} $|$ {\href{www.kenf.dev}{\underline{www.kenf.dev}}} \\
...
\section{EDUCATION}
  \resumeSubHeadingListStart
    ...
    \resumeDescription{Relevant Coursework: CS5250 Advanced Operating Systems, CS3211 Concurrent Programming}
...
\section{PROJECTS / EXTRACURRICULARS}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Enhanced security posture by facilitating acilitiating p2p connections with Tailscale as a Zero Trust Network (ZTN) solution}
