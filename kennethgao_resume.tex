...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Constructed knowledge graphs from unstructured text with GenAI to enhance multi-hop question answering (QA) performance during retrieval augmented generation (RAG), leading to improved context precision}
    \resumeItemListEnd
