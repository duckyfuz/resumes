...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeDescription{B.Eng Computer Engineering (E-Scholars Programme) - 4.9GPA}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    % \resumeItemListStart
    %   \resumeItem{Interning under the Security team}
    % \resumeItemListEnd

    \resumeSubheading{\textbf{Founding Software Engineer @ Check (Iterative W25)} $|$ www.checkeduai.com}{Feb. 2025 - May 2025}
    \resumeDescription{Check revolutionizes student learning through AI-driven active recall, syllabus accuraact, and smart analytics}
    \resumeItemListStart
...
\section{Projects / Extracurriculars}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading{\textbf{Basic Home Server} $|$ Repurposed laptop running Ubuntu Server for personal use}{Feb. 2024 - Present}
    \resumeItemListStart
