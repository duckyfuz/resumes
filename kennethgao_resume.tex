...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\large{Kenneth Gao}} $|$ {\href{mailto:kenneth.gao@u.nus.edu}{kenneth.gao@u.nus.edu}} $|$ {\href{www.kenf.dev}{\underline{www.kenf.dev}}} & \textbf{Availability: }Aug. 2026 onwards \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Enhanced job runner observability by implementing Datadog APM instrumentation for end-to-end traceability}
