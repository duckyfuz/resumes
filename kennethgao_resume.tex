...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    % \resumeSubheading{\textbf{Software Engineering Intern @ \textit{Open Government Products (OGP)}}}{Sep. 2025 - Dec. 2025}
    % \resumeDescription{OGP builds technology for the public good, solving problems for citizens and public officers}
    % \resumeItemListStart
    %   \resumeItem{Incoming intern at Armoury (https://reports.open.gov.sg/armoury/overview)}
    % \resumeItemListEnd
