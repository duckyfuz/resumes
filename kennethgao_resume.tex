...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://kenf.dev/}{\Large Kenneth Gao}} $|$ {\href{mailto:hello@kenf.dev}{hello@kenf.dev}} $|$ {\href{www.kenf.dev}{www.kenf.dev}} & \textbf{Availability: 5th May 2025 - 9th Aug 2025} \\
...
\section{Awards}
  \resumeSubHeadingListStart
    \resumeProjectHeading{\textbf{Hack\&Roll 2025} - \emph{T9} $|$ \textbf{NUS-ISE BACC 2024} - \emph{3rd} $|$ \textbf{Ground Zero 2024} - \emph{Finals} $|$ \textbf{Splash Awards 2023} - \emph{1st}}{}
    \resumeProjectHeading{\textbf{SUTD WhatTheHack 2023} - \emph{1st} $|$ \textbf{HTX HacX! 2023} - \emph{3rd} $|$ \textbf{CloudHacks 2023} - \emph{1st}}{}
  \resumeSubHeadingListEnd
